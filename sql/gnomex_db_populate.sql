...
VALUES ('COMPLETE', 'Complete', 'Y', null),
  ...
  ('NOSEQASSEM', 'Illumina NovaSeq Seq Prep', 'Y', 3),
  ('NOSEQPIPE', 'Illumina NovaSeq Data Pipeline', 'Y', 4),
  ('NOSEQPREP', 'Illumina NovaSeq Library Prep', 'Y', 2),
  ('NOSEQPREPQC', 'Illumina NovaSeq Library Prep QC','Y',null),
  ('NOSEQQC','Illumina NovaSeq Quality Control','Y',null),
  ('NOSEQRUN', 'Illumina NovaSeq Sequencing Run', 'Y', null),
