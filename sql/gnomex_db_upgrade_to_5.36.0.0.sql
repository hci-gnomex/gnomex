...
CALL ExecuteIfTableExists('gnomex','Request_Audit','alter table Request add column reagent varchar(50) null');
CALL ExecuteIfTableExists('gnomex','Request_Audit','alter table Request add column elutionBuffer varchar(50) null');
CALL ExecuteIfTableExists('gnomex','Request_Audit','alter table Request add column usedDnase char(1) null');
CALL ExecuteIfTableExists('gnomex','Request_Audit','alter table Request add column usedRnase char(1) null');
CALL ExecuteIfTableExists('gnomex','Request_Audit','alter table Request add column keepSamples char(1) null');