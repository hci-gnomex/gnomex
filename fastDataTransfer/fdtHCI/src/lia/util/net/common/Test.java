/*
 * $Id: Test.java,v 1.1 2012-10-29 22:29:44 HCI\rcundick Exp $
 */
...
public class Test {
	public static void main(String[] args) {
		...
		String sshFormat = "((([a-zA-Z0-9][a-zA-Z0-9]*)@)?(([a-zA-Z0-9][a-zA-Z0-9\\-]*\\.?)+):)?((" + (Constants.FILE_SEPARATOR_CHAR== '\\' ? Constants.FILE_SEPARATOR_CHAR: "") + File.separatorChar
		+ "?[a-zA-Z_\\-0-9\\.]*)+)";// 
