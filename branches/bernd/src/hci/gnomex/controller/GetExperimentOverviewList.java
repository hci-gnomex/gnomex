  ...
  public Command execute() throws RollBackCommandException {
    ...
    try {
      ...
      if (this.getSecurityAdvisor().hasPermission(SecurityAdvisor.CAN_MANAGE_WORKFLOW)) {
        ...
        log.info("GetExperimentOverviewList query: " + queryBuf.toString());
        System.err.println("QUERY for expoverview: " + queryBuf.toString());
        ...
        //    System.err.println("CodeStep for" + n.getAttribute("sampleId") + " -- " + n.getAttribute("sampleCodeStepNext"));
