package views.util
{
	...
	public class TextInputRequiredIndicator extends TextInput
	{
		...
		protected function change(event:Event):void {
			if (this.textField.text != null && (this.textField.text == "" ||  this.textField.text == 'Enter URL here...') && this._isRequired) {
				if(this.getStyle("backgroundColor") != missingRequiredFieldBackground) {
					defaultColor = this.getStyle("backgroundColor");
				}	
