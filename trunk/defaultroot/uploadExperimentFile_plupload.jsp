...
$(function() {
	...
	$("#flash_uploader").pluploadQueue({
		// General settings
		runtimes : 'flash',
		url : 'UploadExperimentFileServlet.gx',
    multipart : true,
    multipart_params : {requestNumber : "<%=request.getParameter("requestNumber")%>" },
		chunk_size : '1mb',
		unique_names : true,
		filters : [
...
<h4>Upload files to Experiment <%=request.getParameter("requestNumber")%> - <%=request.getParameter("requestNumber")%></h4>
<div id="html4_uploader" style="width: 650px; height: 330px;">Your browser doesn't have HTML 4 support.</div>
</form>
<p class="warning">
When finished uploading, press 'Refresh' link in GNomEx Experiment Detail to see complete list of files.
</form>
<p class="credit">
