...
// start the world
                ...
                $scope.find = function () {
                    ...
                    $scope.showColumnForm = true;
                    $scope.treeHeight = window.innerHeight - 200 + 'px';
                    $scope.treeOverflow = 'auto';
                    $scope.listHeight = window.innerHeight - 244 + 'px';
                    $scope.listOverflow = 'auto';
