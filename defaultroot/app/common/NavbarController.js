...
// start the world
            ...
            $scope.showReportModal = function (e) {
                $scope.reportIssueModal = $modal.open({
            ...
            function lookupType(whatToLookup) {
                ...
                if (whatToLookup.startsWith("A")) {
                    type = "A";
                } else if (whatToLookup.startsWith("DT")) {
                    type = "DT";
                } else if (whatToLookup.startsWith("T")) {
                    type = "T";
                }
