...
public class ShowDataTrackInfo extends GNomExCommand implements Serializable {
	...
	public Command execute() throws RollBackCommandException {
		...
		try {
			...
			String instituteName = dataTrack.getIdInstitution() != null ? DictionaryManager.getDisplay("hci.gnomex.model.Institution", dataTrack
					.getIdInstitution().toString()) : "&nbsp;";
			...
			row.addElement("TD").addCDATA(
					dataTrack.getCodeVisibility() != null && !dataTrack.getCodeVisibility().equals("") ? DictionaryManager.getDisplay(
							"hci.gnomex.model.Visibility", dataTrack.getCodeVisibility().toString()) : "&nbsp;");
