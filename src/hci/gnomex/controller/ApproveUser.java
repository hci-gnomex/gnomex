	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if (au == null) {
				...
				String body = "Welcome to GNomEx.  Your user account has been activated.<br><br>"
						+ gnomexURL
						+ "<br><br> **Please note if you requested the creation of a new lab please wait until you receive notification that you have been added to that lab before trying to submit an experiment.**";

				MailUtilHelper helper = new MailUtilHelper(au.getEmail(), doNotReplyEmail, "Your GNomEx account is now active", body, null, true,
