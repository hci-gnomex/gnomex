  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    try {
      ...
      if (au == null) {
        ...
        MailUtilHelper helper = new MailUtilHelper(email, doNotReplyEmail, "Your GNomEx account has NOT been approved.", "You have not been given access to GNomEx. Please contact the P.I. of the lab you were requesting access to for the reason behind this.  If you requested the creation of a new lab, please contact the core facility director whose core you were trying to join.  Thank you.", null, true, dictionaryHelper, serverName);
      ...
      } else if (au.getGuid() != null && au.getGuid().equals(guid) && au.getGuidExpiration() != null && au.getGuidExpiration().after(new Date(System.currentTimeMillis()))) { // guid
                                                                                                                                                                              // matches
        au.setIsActive("Y");
        au.setGuid(null);
