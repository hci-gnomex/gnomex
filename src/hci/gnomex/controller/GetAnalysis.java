...
public class GetAnalysis extends GNomExCommand implements Serializable {
				...
				for (Iterator i = analysisNumbers.iterator(); i.hasNext();) {
					...
					for (Iterator i1 = directoryKeys.iterator(); i1.hasNext();) {
						...
						if (showUploads.equals("Y")) {
							...
							GetAnalysisDownloadList.addExpandedFileNodes(false, baseDir, aNode, analysisUploadNode, analysisNumber, key, dh,
	...
	/**
	 * The callback method allowing you to manipulate the HttpServletRequest prior to forwarding to the response JSP. This can be used to put the results from
