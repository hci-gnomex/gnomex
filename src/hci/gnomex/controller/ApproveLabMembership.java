	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if (au == null) {
				...
				MailUtilHelper helper = new MailUtilHelper(email, doNotReplyEmail, "Your GNomEx lab membership request was denied",
						"You have not been given access to the " + lab.getName(true, true)
								+ ". Please contact the P.I. of the lab you were requesting access to for the reason behind this.  Thank you.", null, true,
				...
				MailUtilHelper helper = new MailUtilHelper(au.getEmail(), doNotReplyEmail, "Your GNomEx lab membership request was approved.", body, null,
						true, dictionaryHelper, serverName);
				helper.setRecipientAppUser(au);
				MailUtil.validateAndSendEmail(helper);
