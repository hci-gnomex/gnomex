  ...
  public Command execute() throws RollBackCommandException {
    ...
    try {
      ...
      for(Iterator i = r.getWorkItems().iterator(); i.hasNext();){
        ...
        if(!wi.getCodeStepNext().equals(Step.HISEQ_QC) && !wi.getCodeStepNext().equals(Step.HISEQ_PREP) && !wi.getCodeStepNext().equals(Step.MISEQ_QC) && !wi.getCodeStepNext().equals(Step.MISEQ_PREP) ){
          this.addInvalidField("Cannot convert Experiment", "This request contains work items that have passed the library prep phase.  Therefore conversion is not possible.");
          break;
        }
      }
