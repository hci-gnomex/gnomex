...
public synchronized static SessionFactory configureSessionFactory(String configpath) {
	...
	final ServiceRegistry registry = new StandardServiceRegistryBuilder().configure(configpath) // configures settings from hibernate.cfg.xml
			.build();
	...
	try {
		...
		LOG.error("Error in HibernateUtil:SessionFactory ", e);
