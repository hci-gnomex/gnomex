...
(function() {
    ...
    nv.tooltip.calcTooltipPosition = function(pos, gravity, dist, container) {
        ...
        var offWidth = document.getElementsByTagName("html")[0].offsetWidth;
    	var winWidth = nv.utils.windowSize().width;
    	var ratioWidth = offWidth / winWidth;
                ...
                pieLabels.select(".nv-label text")
                    ...
                    .text(function(d, i) {
                        ...
                        var labelTypes = {
                            ...
                            "custom": getX(d.data) + " : " + getY(d.data) + " ( " + labelFormat(percent) + "% )"
                        };
