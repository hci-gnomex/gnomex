...
public class BillingAccount extends HibernateDetailObject {
	...
	public String getAccountNumber() {
		...
		if ((accountNumberBus != null && !accountNumberBus.equals("")) || (accountNumberOrg != null && !accountNumberOrg.equals(""))
				|| (accountNumberFund != null && !accountNumberFund.equals("")) || (accountNumberActivity != null && !accountNumberActivity.equals(""))
				|| (accountNumberProject != null && !accountNumberProject.equals("")) || (accountNumberAccount != null && !accountNumberAccount.equals(""))
				|| (accountNumberAu != null && !accountNumberAu.equals("")) || (accountNumberYear != null && !accountNumberYear.equals(""))) {
			return this.getNonNullString(accountNumberBus)
					...
					+ this.getAccountNumberPart(accountNumberAccount + this.getAccountNumberPart(accountNumberAu)
	...
	public String getAccountNameAndNumber() {
		...
		if (getExpirationDate() != null) {
			edate = " - " + this.formatDate(getExpirationDate(), this.DATE_OUTPUT_DASH_SHORT);
		}
		return getAccountName() + number + edate;
	}
