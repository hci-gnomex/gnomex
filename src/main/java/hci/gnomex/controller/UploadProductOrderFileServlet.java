...
protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	try {
		...
		if (secAdvisor == null) {
			System.out
					.println("UploadProductOrderFileServlet:  Warning - unable to find existing session. Creating security advisor.");
		...
		if (productOrder != null) {
			...
			System.out.println("UploadProductOrderFileServlet - unable to upload file " + fileName
					+ " for productOrder idProductOrder=" + idProductOrder);
