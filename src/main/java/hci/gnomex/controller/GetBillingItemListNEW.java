...
public class GetBillingItemListNEW extends GNomExCommand implements Serializable {
  ...
  public Command execute() throws RollBackCommandException {
    ...
    try {
      ...
      // Find requests that do not have any billing items under their active billing template
      ...
      this.errorDetails = Util.GNLOG(LOG,"An exception has occurred in GetBillingItemList ", e);
