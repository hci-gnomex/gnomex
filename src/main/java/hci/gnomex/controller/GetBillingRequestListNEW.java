...
public class GetBillingRequestListNEW extends GNomExCommand implements Serializable {
    private static Logger LOG = Logger.getLogger(GetBillingRequestListNEW.class);
    ...
    public Command execute() throws GNomExRollbackException {
        try {
            ...
            this.errorDetails = Util.GNLOG(LOG, "An exception has occurred in GetBillingRequestListNEW", e);
