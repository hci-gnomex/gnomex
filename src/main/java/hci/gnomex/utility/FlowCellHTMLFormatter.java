		...
		for (Iterator i = channels.iterator(); i.hasNext();) {
			...
			if (channel.getSequencingControl() != null) {
				...
				for (Iterator i1 = channel.getSequenceLanes().iterator(); i1.hasNext();) {
					...
					this.addCell(row, channel.getNumberSequencingCyclesActual() != null && !channel.getNumberSequencingCyclesActual().equals("") ? channel
							.getNumberSequencingCyclesActual().toString() : "&nbsp;");
					this.addCell(row, channel.getRead1ClustersPassedFilterM() != null && !channel.getRead1ClustersPassedFilterM().equals("") ? channel
							.getRead1ClustersPassedFilterM().toString() : "&nbsp;");
		...
		for (Iterator i = channels.iterator(); i.hasNext();) {
			...
			if (channel.getSequencingControl() != null) {
				...
				for (Iterator i1 = channel.getSequenceLanes().iterator(); i1.hasNext();) {
					...
					this.addCell(row, lane.getIdSeqRunType() != null ? dictionaryHelper.getSeqRunType(lane.getIdSeqRunType()) : "&nbsp;");
					this.addCell(row,
							lane.getIdNumberSequencingCycles() != null ? dictionaryHelper.getNumberSequencingCycles(lane.getIdNumberSequencingCycles())
									: "&nbsp;");
					firstLaneInChannel = false;
				}
