/*
 * $Id: GSIBaseServer.java,v 1.1 2012-10-29 22:29:57 HCI\rcundick Exp $
 */
package lia.gsi.net;
...
/**
 * 
 * This class provides the basics for writing various servers. <b>Note:</b> Sockets created by this server have a 5 minute default timeout. The timeout can be changed using the
 * {@link #setTimeout(int) setTimeout()} function.
 * 
...
public abstract class GSIBaseServer implements Runnable {
	...
	/**
	 * Returns hostname of this server. The format of the host conforms to RFC 2732, i.e. for a literal IPv6 address, this method will return the IPv6 address enclosed in square
	 * brackets ('[' and ']').
	 * 
	 * @return hostname
	 */
	...
	/**
	 * Registers a default deactivation handler. It is used to shutdown the server without having a reference to the server. <br>
