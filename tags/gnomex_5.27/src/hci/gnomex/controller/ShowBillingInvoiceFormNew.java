...
public class ShowBillingInvoiceFormNew extends ReportCommand implements Serializable {
	...
	public Command execute() throws RollBackCommandException { 
		try {
		    ...
		    log.error("An exception has occurred in ShowBillingInvoiceFormNew ", e);
		    e.printStackTrace();
