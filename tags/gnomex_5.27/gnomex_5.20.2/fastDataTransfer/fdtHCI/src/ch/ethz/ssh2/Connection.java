 ...
 * @version $Id: Connection.java,v 1.1 2012-10-29 22:29:49 HCI\rcundick Exp $
 */
...
public class Connection
{
	 ...
	 * callback object which will be fed with challenges generated by the
	 ...
	 * as the more exotic PEM encryptions AES-128-CBC, AES-192-CBC and AES-256-CBC.
	 * <p>
	 * If the authentication phase is complete, <code>true</code> will be
	 * returned. If the server does not accept the request (or if further
	 * authentication steps are needed), <code>false</code> is returned and
