package views.renderers
{
	...
	public class TextInputSampleLibFragSizeFrom extends TextInput
	{
    	...
    	override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
     	{
          ...
          g.clear();
          g.beginFill( data.@seqPrepGelFragmentSizeFrom == '' ? RendererFactory.DEFAULT_MISSING_REQUIRED_FIELD_BACKGROUND : 0xffffff );
          if (data.@seqPrepGelFragmentSizeFrom == '' ) {
