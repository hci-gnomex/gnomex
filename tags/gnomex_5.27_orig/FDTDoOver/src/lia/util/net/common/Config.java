/*
 * $Id: Config.java 705 2013-05-27 20:40:15Z ramiro $
 */
...
public class Config {
	...
	public static final String FDT_MAINTENANCE_VERSION = "6";
	public static final String FDT_FULL_VERSION = FDT_MAJOR_VERSION + "." + FDT_MINOR_VERSION + "."
	+ FDT_MAINTENANCE_VERSION;
	public static final String FDT_RELEASE_DATE = "2013-07-01";
	...
	// for logging data transfers to a special application logger for GNomEx
	...
	private Config(final Map<String, Object> configMap) throws InvalidFDTParameterException {
		...
		if (hostname != null) {// client mode
			...
			// look to see if they want to call a special logger script for monitoring transfers for GNomEx
			if (configMap.containsKey("-appLogger")) {
				appLogger = (String)configMap.get("-appLogger");
				logger.log(Level.INFO, "App Logger: "+appLogger);
			}
		}
	}
