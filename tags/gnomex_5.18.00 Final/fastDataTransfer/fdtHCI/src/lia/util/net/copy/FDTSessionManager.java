/*
 * $Id: FDTSessionManager.java,v 1.1 2012-10-29 22:29:40 HCI\rcundick Exp $
 */
...
public class FDTSessionManager extends AbstractFDTCloseable implements ControlChannelNotifier {
    ...
    public FDTSession addFDTClientSession() throws Exception {
        ...
        try {
            ...
            ShowMessageDialog.showErrorDialog("The server is not responding. Please contact the system administrator and verify it is running.", "Server Response Error");
