...
set JDBC_DRIVER=%ORION_HOME%\lib\mysql-connector-java-5.1.7-bin.jar;%ORION_HOME%\lib\sqljdbc4.jar%ORION_HOME%\lib\msutil.jar;%ORION_HOME%\lib\msbase.jar;%ORION_HOME%\lib\mssqlserver.jar;%ORION_HOME%\lib\sqljdbc4.jar
